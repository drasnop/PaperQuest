...
var parameters= {
  ...
  "descriptionFringe": "<h2> The Fringe </h2> Papers related to the ones in Read, To Read or selected. The most relevant papers appear at the top. <br><br> <b>Click</b> to select interesting papers, then <b>scroll</b> to show authors & abstracts. <br><br> The size of the circles represent the citation counts; <br> their color represent how strongly connected they are to other interesting papers. <br><br> Click <em>Update fringe</em> to compute a new Fringe based on all the papers you have expressed interest in."
}
