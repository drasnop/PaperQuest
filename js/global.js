...
var global = (function() {
   ...
   global.computeOldestLatestPublicationYears = function() {
      global.oldestPublicationYear = d3.min(Object.keys(global.papers), function(doi) {
         return global.papers[doi].year;
      });
      global.latestPublicationYear = d3.max(Object.keys(global.papers), function(doi) {
         return global.papers[doi].year;
      });
   ...
   global.publicationYears = function() {
      return papersShownInSidebar().map(function(p) {
         return p.year;
      })
   }
